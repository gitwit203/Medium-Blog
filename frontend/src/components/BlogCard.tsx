...
export const BlogCard = ({
    ...
    return <Link to ={`/blog/${id}`}>
        <div className="p-4 border-b-2 border-slate-200 pb-4 max-w-md cursor-pointer">
...
export function Avatar({name,size="small"}: {name:string,size?: "small"|"big"}){
    ...
    items-center justify-center overflow-hidden bg-gray-600 
    rounded-full ${size==="small" ? "w-6 h-6" : "w-10 h-10"}
    dark:bg-gray-600`}>
